...
public class PanelView extends View {
    ...
    public PanelView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMinCircleColor = a.getColor(R.styleable.PanelView_pointerColor, getResources().getColor(R.color.colorPrimary));
...
//        Log.e("wing", fill + "");
        ...
        p.setColor(getResources().getColor(R.color.colorbg));
        //画弧胡的未充满部分
