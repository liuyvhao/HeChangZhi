...
public class QuickAlphabeticBar extends AppCompatImageButton {
    ...
    public void init(Activity ctx) {
        mDialogText = ctx.findViewById(R.id.fast_position);
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            if (mDialogText != null
                                ...
                                setBackground(getResources().getDrawable(R.drawable.water_bg));
                            }
                        }
                    });
                }
...
//            paint.setTypeface(Typeface.DEFAULT_BOLD);
            ...
            if (i == choose) {
                paint.setColor(Color.parseColor("#3BC6BC")); // 滑动时按下字母颜色
